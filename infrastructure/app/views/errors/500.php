...
<head>
    ...
    <title>500 Server Error — Club&amp;Event Seeker</title>
...
<div style="text-align:center;padding:6rem 1.5rem;color:var(--text-muted);">
    <p style="font-size:4rem;line-height:1;">🔥</p>
    <h1 style="font-size:2rem;font-weight:700;color:var(--text-main);margin:0.75rem 0;">500 — Server Error</h1>
