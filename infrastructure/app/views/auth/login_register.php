...
<head>
    ...
    <title>Cổng Thông Tin Sinh Viên - Đăng Nhập</title>
</head>
<body>
        ...
        <div class="header-container">
            <div class="logo-area">
                ...
                <div class="brand-text">
                    <span class="sub-title">ĐẠI HỌC QUỐC GIA HÀ NỘI</span>
                    <span class="main-title">TRƯỜNG QUỐC TẾ</span>
                    <span class="eng-title">VNU - INTERNATIONAL SCHOOL</span>
                </div>
            </div>
        </div>
    </header>
    ...
    <nav class="is-navbar">
        <div class="navbar-container">
            <a href="#" class="nav-tab active">THÔNG BÁO</a>
            <a href="#" class="nav-tab">HƯỚNG DẪN</a>
            <a href="#" class="nav-tab">BIỂU MẪU</a>
            <a href="#" class="nav-tab">QUY CHẾ - QUY ĐỊNH</a>
            <a href="#" class="nav-tab">CÁC CHƯƠNG TRÌNH LKQT</a>
        </div>
    </nav>
        ...
        <div class="portal-container">
            ...
            <section class="announcements-column">
                ...
                <div class="announcement-item">
                    ...
                    <div class="announcement-content">
                        <a href="#" class="announcement-title">THÔNG BÁO LỊCH ĐĂNG KÝ THAM GIA CÁC CÂU LẠC BỘ SINH VIÊN NĂM HỌC 2026-2027</a>
                ...
                <div class="announcement-item">
                    ...
                    <div class="announcement-content">
                        <a href="#" class="announcement-title">Thông báo lịch điểm danh và sơ đồ gian hàng sự kiện Chào tân sinh viên K24</a>
                        <a href="#" class="detail-link">Xem chi tiết</a>
                    </div>
                </div>
                ...
                <div class="announcement-item">
                    ...
                    <div class="announcement-content">
                        <a href="#" class="announcement-title">Hướng dẫn đăng ký sử dụng phòng đa năng và cơ sở vật chất phục vụ hoạt động câu lạc bộ ngoại khóa</a>
                        <a href="#" class="detail-link">Xem chi tiết</a>
                    </div>
                </div>
                ...
                <div class="announcement-item">
                    ...
                    <div class="announcement-content">
                        <a href="#" class="announcement-title">Danh sách báo cáo hoạt động và xếp hạng đánh giá thi đua các câu lạc bộ trong học kỳ vừa qua</a>
                        <a href="#" class="detail-link">Xem chi tiết</a>
                    </div>
                </div>
            ...
            <aside class="auth-column">
                ...
                <div class="auth-card" id="login-section">
                    <h2 class="portal-main-title">CỔNG THÔNG TIN SINH VIÊN</h2>
                    <h3 class="portal-sub-title">ĐĂNG NHẬP HỆ THỐNG</h3>

                    <form action="<?= BASE_URL ?>/auth/login" method="POST">
                        <div class="form-group">
                            <input type="text" name="studentID" class="form-input" placeholder="Nhập mã sinh viên" required>
                        </div>
                        <div class="form-group password-group">
                            ...
                            <div class="graduated-option">
                                <label class="checkbox-label">
                                    <input type="checkbox" name="graduated"> Đã tốt nghiệp
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="captcha-group">
                            <input type="text" class="form-input captcha-input" placeholder="Nhập mã" required>
                    ...
                    <!-- Parent Link -->
                    <button type="button" class="btn btn-parents">Dành cho phụ huynh</button>

                    <!-- Mobile App Download -->
                    <div class="app-download-section">
                        <p class="app-title">Tải App Mobile sinh viên:</p>
                        <div class="app-flex">
                ...
                <div class="auth-card hidden" id="register-section">
                    <h2 class="portal-main-title">CỔNG THÔNG TIN SINH VIÊN</h2>
                    <h3 class="portal-sub-title">ĐĂNG KÝ TÀI KHOẢN MỚI</h3>
